...
export default function ODashboard() {
  ...
  const imageWidthPercent = isSm ? 40 : isMd ? 50 : 55;
    ...
    <SafeAreaView style={tw`flex-1 bg-white`}>
      <ScrollView style={tw`flex-1`} showsVerticalScrollIndicator={false}>
        ...
        <View style={tw`mt-8 px-5`}>
          ...
          <View style={tw`rounded-2xl border-3 border-[#AFC8AD] bg-[rgba(175,200,173,0.32)] p-5 mt-4`}>
            ...
            <View style={styles.machineImageContainer}>
              <ResponsiveImage
                ...
                aspectRatio={1}
                maxWidthPercent={imageWidthPercent} 
              />
            </View>
